...
import com.aem.demo.core.models.DownloadPdfRequest;
import com.aem.demo.core.models.PdfDetails;
import com.aem.demo.core.service.DownloadPdfService;
import com.aem.demo.core.utils.RequestBodyParamBuilder;
...
public class DownloadPdfServlet extends SlingAllMethodsServlet {
    ...
    protected void doGet(SlingHttpServletRequest request, SlingHttpServletResponse response) throws ServletException, IOException {
        ...
        DownloadPdfRequest downloadPdfRequest = new RequestBodyParamBuilder<DownloadPdfRequest>().getParamObject(request, DownloadPdfRequest.class);
        String apiResponse = "";
        ObjectMapper mapper = new ObjectMapper();
        try {
            List<PdfDetails> pdfDetailsList = downloadPdfService.getPdfFiles(downloadPdfRequest.getPath(), downloadPdfRequest.getTags());
